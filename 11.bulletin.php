<?php
    ...
    if (!$_SESSION["id"]) {
        ...
        echo "歡迎, ".$_SESSION["id"]."[<a href=12.logout.php>登出</a>][<a href=14.user_add_form.php>新增使用者</a>][<a href=18.user.php>管理使用者</a>] [<a href=22.bulletin_add_form.php>新增佈告</a>]<br>";
